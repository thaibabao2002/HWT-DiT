...
# Number of Python threads to use for the data_loader loader (warning: using too many
...
__C.MODEL.model = 'PixArtMS_XL_2'
__C.MODEL.fp32_attention = True
__C.MODEL.grad_checkpointing = True
__C.MODEL.pred_sigma = False
__C.MODEL.lewei_scale = 1.0
...
def _decode_cfg_value(v):
    ...
    # sometimes it *represents* a string and other times a data_loader structure, like
