...
class ProcessedDataset:
    ...
    def split(self, ratio=0.5) -> tuple[ProcessedDataset, ProcessedDataset]:
        ...
        dataset1 = ProcessedDataset(self.ids[mask1], [label for label, m in zip(self.labels, mask1) if m],
                                    self.features[mask1])
        dataset2 = ProcessedDataset(self.ids[mask2], [label for label, m in zip(self.labels, mask2) if m],
                                    self.features[mask2])
